...
<p><a href="../BaseLR/<?php echo get_settings('siteurl'); ?>/wp-commentsrss2.php?p=<?php echo $post->ID; ?>"><abbr title="Really Simple Syndication">RSS</abbr> feed for comments on this post.</a></p>
...
if (function_exists('get_avatar')) {
      ...
      $grav_url = "http://www.gravatar.com/avatar.php?gravatar_id=
         " . md5($comment) . "&default=" . urlencode($default) . "&size=" . $size;
