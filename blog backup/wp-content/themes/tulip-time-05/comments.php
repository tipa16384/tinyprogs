...
<?php if ($comments) : ?>
	<h3 id="comments">There <?php comments_number('is', 'is', 'are' );?> currently <?php comments_number('zero responses', 'one response', '% responses' );?> to &#8220;<?php the_title(); ?>&#8221;</h3> 
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			...
			On <?php comment_date('F jS, Y') ?>, <cite><?php comment_author_link() ?></cite> said:
			...
			<p class="commentmetadata">posted on <?php comment_date('F jS, Y') ?> at <?php comment_time() ?><?php edit_comment_link(' e','',''); ?></p>
