...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			<div class="cmtinfo"><em>on <?php comment_date('d M Y') ?> at <?php comment_time() ?></em><span class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><span class="commentnum"><?php echo $commentcounter; ?></span></a> <cite><?php comment_author_link() ?></cite> <?php edit_comment_link('(edit)','',''); ?></span></div>
