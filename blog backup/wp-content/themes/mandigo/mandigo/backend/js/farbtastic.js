...
jQuery._farbtastic = function (container, callback) {
  ...
  // Insert markup
  jQuery(container).html('<div class="farbtastic"><div class="color"></div><div class="wheel"></div><div class="overlay"></div><div class="h-marker marker"></div><div class="sl-marker marker"></div></div><div align="center"><a href="#" onclick="jQuery(\'.farbtastic\').parent().fadeOut(); return false;">close</a></div>');
